...
class Policy(nn.Module):
    ...
    def dda_operations():
        ...
        out = [
            ...
            Solarize(initial_magnitude=mag),    # properly works # jun ota memo
            Posterize(initial_magnitude=mag),   # properly works # jun ota memo
            Contrast(initial_magnitude=mag),    # properly works # jun ota memo
            Saturate(initial_magnitude=mag),    # properly works # jun ota memo
            Brightness(initial_magnitude=mag),  # properly works # jun ota memo
            Sharpness(initial_magnitude=mag),   # properly works (subclass of _KernelOperation) # jun ota memo
            AutoContrast(),                     # properly works # jun ota memo
            Equalize(),                         # properly works # jun ota memo
        ]
        return out
